...
const SidebarProjects = ({
    ...
    return (
        <div
            className={` w-48 h-screen border-r border-gray-200 py-3 md:py-0 overflow-y-auto`}
        >
            <div
                className={` flex flex-col pt-14 md:pt-0   `}
                style={{ marginTop: `${valueWorksRef / 1.2 + "px"}` }}
            >
